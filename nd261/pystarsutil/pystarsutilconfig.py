...
#    def __init__(self, debug=False, default_section=''):
        ...
        try:
            ...
            print('\n' + '  <<<<<< >>>>>>>   Point-CF300   default_section = ' + str(default_section) + '\n')     # for making sure 20230105
        except Exception as e:
            print('  <<<<<< >>>>>>>   Point-CF310')     # for making sure 20230105
            self._confighandle = None
