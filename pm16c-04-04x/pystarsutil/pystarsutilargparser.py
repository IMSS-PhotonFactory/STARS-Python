...
#        pparser.add_argument('--channeltargetnolist',   dest="ChannelTargetNoList"  , help='ID list of device channels.')
#        pparser.add_argument('--channelnamelist', dest="ChannelNameList", help='Name list of device channels.')
#        pparser.add_argument('--numberofchannels', type=int, dest="NumberOfChannels", help='Number of channels.')
...
#        b = self._optdict['useLogOutput']       # b = true
#        if(b == True):
...
#                pparser.add_argument('--loglevel'   , type=int          , dest='loglevelnum'          , help='set level number of log messages. Use with --logenable')
        ...
        num = self._optdict['numberOfStarsServer']  # num = 1
        if(num>0):
        ...
        num = self._optdict['numberOfDeviceServer'] # num = 1
        if(num>0):
        ...
        b = self._optdict['useConfig'] # b = True
        if(b == True):
